...
export async function onRequestDelete({request,env}){
  ...
  const own=build.created_by===auth.user.id;const allowed=(own&&perms.includes('delete_own_builds'))||perms.includes('moderate_builds')||perms.includes('admin_dashboard');
